...
pub fn handle_f32_load(
    ...
    let (addr_reg, address_type) = stack.pop().expect("Stack underflow during F32Load (offset)");
    // Convert to U64, not F64! Addresses must be integers in PTX
